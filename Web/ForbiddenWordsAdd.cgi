...
newForbidden = form.getfirst('newForbidden','')
html="""<body onload="redirect('ForbiddenWordsList.cgi')">{content}"""
#database connection
user = "i494f18_team34"
...
if admin == True:
        ...
        if newForbidden != "":
                try:
                        SQL = "INSERT INTO ban_word(keyword) VALUES('"+str(newForbidden)+"');"
                        cursor.execute(SQL)
                        db_con.commit()
