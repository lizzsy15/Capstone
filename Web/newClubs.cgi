    ...
    <!-- the whole container -->
		<article class="CenterPart">
          ...
          <h1> New Posts </h1>
	          ...
	          <ul>
							<li><div class="listRow"><p><a href="#">Contest No. 9 - Foe</a></p><p class="boardTitle"><a href="#">Kingdom Heart 5</a></p></div></li>
							<li><div class="listRow"><p><a href="#">Contest No. 9 - Foe</a></p><p class="boardTitle"><a href="#">Kingdom Heart 5</a></p></div></li>
							<li><div class="listRow"><p><a href="#">Contest No. 9 - Foe</a></p><p class="boardTitle"><a href="#">Kingdom Heart 5</a></p></div></li>
							<li><div class="listRow"><p><a href="#">Contest No. 9 - Foe</a></p><p class="boardTitle"><a href="#">Kingdom Heart 5</a></p></div></li>
							<li><div class="listRow"><p><a href="#">Contest No. 9 - Foe</a></p><p class="boardTitle"><a href="#">Kingdom Heart 5</a></p></div></li>
...
try:
        SQL = "SELECT clubname, description, icon FROM club Order By clubID desc LIMIT 3;"
        cursor.execute(SQL)
        ...
        for row in results:
            content += '<div class="club">'
            content += '<img src="images/'+row[2]+'" alt="club1">'
            content += '<div class="clubContent">'
            content += '<p class="title"><a href="#">'+row[0]+'</a> </p>'
            content += '<p>'+row[1]+'</p></div></div>'
